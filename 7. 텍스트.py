...
# 아이콘 설정
icon = pygame.image.load("C:\\Users\\eyulj\\Desktop\\PythonWorkspace\\나도코딩 게임 개발\\icon.png")
...
# 적 캐릭터
enemy = pygame.image.load("C:\\Users\\eyulj\\Desktop\\PythonWorkspace\\나도코딩 게임 개발\\enemy.png")
enemy_size = enemy.get_rect().size # 이미지의 크기 구하기
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 가로 중간에 위치
enemy_y_pos = (screen_height / 2) - (enemy_height / 2)# 화면 세로 아래에 위치
